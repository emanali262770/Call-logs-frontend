...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (selectedMeeting && selectedMeeting._id) {
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/meetings/${selectedMeeting._id
        }`,
        payload,
        { headers }
      );
            ...
            currentMeetings.map((meeting, index) => (
              ...
              >
                ...
                <td className="py-3 px-4">
                  <span
                    className={`inline-flex px-3 py-1 rounded-full text-xs font-medium ${meeting.status === "Follow Up Required"
